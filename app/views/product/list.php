...
.product-card__footer { display:flex; gap:.5rem; padding:.7rem 1.1rem 1rem; border-top:1px solid #f1f1ff; }
.product-card__footer .btn { flex:1; font-size:.8rem; padding:.4rem .5rem; border-radius:8px; }
