...
<main class="container">
    <section class="form-shell">
        <div class="mb-4">
            <h1 class="h3 fw-black mb-1"><i class="fas fa-plus-circle text-primary me-2"></i>Thêm sản phẩm</h1>
            <p class="text-muted mb-0">Tạo mới qua `/api/products` bằng form API-first.</p>
        </div>

        <div id="productFormAlert" class="alert d-none" role="alert"></div>

        <form id="adminProductForm" data-product-id="0" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="d-flex gap-2 mt-4">
                <button type="submit" class="btn btn-primary px-4" id="adminProductSubmitBtn">
                    <span class="btn-label">Lưu sản phẩm</span>
